...
echo ""
echo "Screen Recording permission is required for screen capture."
echo ""
echo "Please add ALL of these to Screen Recording and enable them:"
echo "  1. screenpipe"
echo "  2. Terminal (or iTerm)"
echo "  3. Python (click + and navigate to):"
echo "     /Library/Frameworks/Python.framework/Versions/3.10/Resources/Python.app"
echo ""
echo "Tip: Press Cmd+Shift+G in the file picker to paste the Python path"
echo ""
open "x-apple.systempreferences:com.apple.preference.security?Privacy_ScreenCapture"
echo ""
read -p "Press Enter after you've enabled all three in Screen Recording..."
